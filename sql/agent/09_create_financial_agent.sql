/*===========================================================================
  ...
  Script: 09_create_financial_agent.sql
...
CREATE OR REPLACE AGENT TSG_INTELLIGENCE.AGENT.TSG_AGENT
  ...
  tools:
    ...
    - tool_spec:
        ...
        description: "Answers questions about operational efficiency including inventory turnover, DSO, supply chain scores, fulfillment rates, on-time delivery, COGS, SG&A, capex, working capital, and cash conversion"
    - tool_spec:
        type: "cortex_search"
